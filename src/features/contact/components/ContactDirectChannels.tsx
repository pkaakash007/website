...
export const ContactDirectChannels: React.FC = () => {
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a
                ...
                className="text-xs text-primary font-mono font-semibold hover:text-gold-700 mt-1 block"
              >
                {SEO_CONFIG.displayPhone}
              </a>
              <div className="text-[11px] text-muted mt-0.5">Monday – Saturday: 09:00 AM – 06:30 PM IST</div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a
                ...
                className="text-xs text-primary font-mono hover:text-gold-700 mt-1 block"
              >
                {SEO_CONFIG.email}
              </a>
              <div className="text-[11px] text-muted">campaigns@realresult.in</div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <a
                ...
                className="text-xs text-emerald-700 font-semibold hover:underline mt-1 block"
              >
                +91 98420 12345 (Direct Strategist Response)
              </a>
              <div className="text-[11px] text-muted">Typical response time: Under 15 minutes during IST business hours</div>
            </div>
          </div>
      ...
      <div className="p-6 rounded-3xl bg-surface border border-border space-y-2.5 text-xs text-secondary">
