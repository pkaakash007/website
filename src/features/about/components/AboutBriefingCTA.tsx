...
import { ShieldCheck, PhoneCall, Building2 } from "lucide-react";
...
export const AboutBriefingCTA: React.FC = () => {
  return (
    <section className="py-20 lg:py-28 bg-canvas border-b border-border">
      <Container size="wide">
        <div className="p-8 lg:p-14 rounded-3xl bg-white border border-border shadow-card relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-8 space-y-5">
              <Badge variant="gold">EXPLORE A STRATEGIC ALLIANCE</Badge>
            ...
            <div className="lg:col-span-4 p-6 rounded-2xl bg-canvas border border-border space-y-4 text-xs text-secondary">
              ...
              <div className="pt-2 border-t border-border/80 flex items-center gap-2 text-primary font-semibold">
