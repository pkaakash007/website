          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="pt-6 border-t border-neutral-200/80 flex flex-wrap items-center justify-between gap-4">
              <Link
                ...
                className="text-sm font-bold text-[#0E2036] hover:text-[#C5A059] flex items-center gap-1.5 transition-colors"
              >
                <span>Explore Marketing Services</span>
              </Link>
              <Link
                to="/services"
                className="text-sm font-semibold text-[#0E2036] hover:text-[#C5A059] flex items-center gap-1.5 transition-colors"
              >
