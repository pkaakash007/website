      ...
      <div className="space-y-6 flex-1">
        ...
        <div className="overflow-hidden rounded-xl aspect-[16/10]">
          <picture>
            <source
              type="image/avif"
              srcSet="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&fm=avif&w=400&q=75 400w, https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&fm=avif&w=600&q=75 600w"
              sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 600px"
            />
            <source
              type="image/webp"
              srcSet="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&fm=webp&w=400&q=75 400w, https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&fm=webp&w=600&q=75 600w"
              sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 600px"
            />
            <img
              src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=75"
              srcSet="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=400&q=75 400w, https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=600&q=75 600w"
              sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 600px"
