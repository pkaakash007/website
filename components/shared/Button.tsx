...
export default function Button({
  ...
  const variantStyles = {
    ...
    teal:
      "bg-gradient-to-r from-gold-400 via-gold-500 to-gold-600 text-black font-semibold hover:brightness-105 shadow-gold-subtle hover:shadow-gold-glow border border-gold-300/40", // Aliased to gold
    dark:
