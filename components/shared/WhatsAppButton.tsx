...
import { getWhatsAppUrl, REAL_RESULT_CONFIG } from "@/lib/config";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-2 pointer-events-auto">
      ...
      <button
        ...
        className="group flex items-center gap-2.5 p-3 sm:px-4 sm:py-3 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white shadow-floating hover:shadow-card-hover transition-all duration-300 border-2 border-white/20 active:scale-95"
