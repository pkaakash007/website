  ...
  if (status === "success") {
    return (
      <div className="p-8 sm:p-10 rounded-3xl bg-white border border-border shadow-card text-center flex flex-col items-center justify-center space-y-4 animate-in fade-in zoom-in-95 duration-300">
        <div className="w-14 h-14 rounded-full bg-brand-teal-light text-brand-teal flex items-center justify-center">
        ...
        <button
          ...
          className="mt-4 text-xs font-medium text-brand-teal-dark hover:underline"
        >
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-canvas border border-border text-sm text-primary placeholder:text-muted focus:outline-hidden focus:border-brand-teal focus:ring-3 focus:ring-brand-teal-light transition-all"
            />
          </div>
          <div>
            <label className="block text-xs font-semibold text-secondary uppercase tracking-wider mb-2">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 rounded-xl bg-canvas border border-border text-sm text-primary placeholder:text-muted focus:outline-hidden focus:border-brand-teal focus:ring-3 focus:ring-brand-teal-light transition-all resize-none"
          />
        </div>
