...
import { REAL_RESULT_CONFIG, getWhatsAppUrl } from "@/lib/config";
...
const supportingDivisions = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Web Applications & Next.js", href: "/technology" },
      ...
      <Container size="wide">
        ...
        <div className="py-8 border-b border-charcoal-border flex flex-col md:flex-row items-start md:items-center justify-between gap-4 text-xs text-charcoal-muted">
          <div className="flex flex-wrap items-center gap-6">
            <Link href="/human-resources" className="hover:text-gold transition-colors font-medium">
              Human Resources & Talent Search
            </Link>
            <Link href="/industries" className="hover:text-gold transition-colors font-medium">
              Industries Served
            </Link>
            <Link href="/insights" className="hover:text-gold transition-colors font-medium">
              Strategic Insights
            </Link>
