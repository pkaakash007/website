...
export const REAL_RESULT_CONFIG = {
  ...
  // Set real phone number in international format without + or spaces (e.g., '14155552671' or '919876543210')
  whatsapp: {
    number: "18005557325", // Centralized editable company number
...
export function getWhatsAppUrl(context: "marketing" | "aiCommunication" | "technology" | "humanResources" | "general" = "general"): string {
