...
export const metadata: Metadata = {
  title: "AI Communication & Regional Voice Telephony | Real Result",
  description:
    "Enterprise AI Telecalling in regional languages, automated bulk IVR, WhatsApp Business API, cloud telephony, and omnichannel CPaaS infrastructure.",
  keywords: [
    "AI Telecalling",
