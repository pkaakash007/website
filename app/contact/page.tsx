...
export const metadata: Metadata = {
  title: "Contact Division Leads | Real Result",
  description:
    "Schedule a consultation with Real Result division directors for Technology, Marketing, AI Communication, or Human Resources.",
};
