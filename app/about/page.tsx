...
import { ShieldCheck, Target, Zap, Users, Sparkles, CheckCircle2 } from "lucide-react";

export const metadata: Metadata = {
  title: "About Real Result | Our Model, Vision & Principles",
  description:
    "Learn how Real Result combines Technology & Software, Marketing & Media, AI Communication, and Human Resources under one unified execution model.",
};
      ...
      <section className="py-20 bg-canvas">
        <Container size="wide">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-3xl bg-white border border-border shadow-card space-y-4">
              <div className="w-12 h-12 rounded-2xl bg-surface border border-border flex items-center justify-center text-brand-teal">
                <Zap className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold text-primary">Technical Rigor</h3>
              <p className="text-xs sm:text-sm text-secondary leading-relaxed">
                Whether developing low-latency regional AI voice models or deploying scalable Next.js and cloud architectures, we adhere strictly to enterprise-grade standards.
              </p>
            </div>
      ...
      <section className="py-20 bg-white border-y border-border">
        <Container size="wide">
          <div className="max-w-3xl mx-auto text-center space-y-4 mb-14">
            <Badge variant="teal">GLOBAL REACH</Badge>
