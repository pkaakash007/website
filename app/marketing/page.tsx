...
export const metadata: Metadata = {
  title: "Marketing & Media Buying | Real Result — Marketing That Moves",
  description:
    "Make your brand impossible to ignore. Full-funnel digital performance, television broadcast, radio, outdoor DOOH, cinema, and omnichannel attribution.",
  keywords: [
